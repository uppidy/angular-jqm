...
angular.module('jqm-templates', ['templates/jqmButton.html', 'templates/jqmCheckbox.html', 'templates/jqmControlgroup.html', 'templates/jqmFlip.html', 'templates/jqmInput.html', 'templates/jqmLiEntry.html', 'templates/jqmLiLink.html', 'templates/jqmListview.html', 'templates/jqmPanel.html', 'templates/jqmPanelContainer.html', 'templates/jqmPopup.html', 'templates/jqmPopupOverlay.html', 'templates/jqmTextarea.html', 'templates/jqmTextinput.html']);
...
angular.module("templates/jqmInput.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("templates/jqmInput.html",
    ...
    "  <a ng-if=\"$scopeAs.jqmTextinput.clearBtn || $scopeAs.jqmTextinput.type === 'search'\" \n" +
    "     ng-class=\"{'ui-input-clear-hidden': !showClearBtn()}\"\n" +
    "     ng-click=\"clearBtnClicked()\"\n" +
