...
describe('headers', function () {
    ...
    describe('markup compared to jqm', function () {
        function compile(ngAttrs, jqmAttrs, content) {
            ngElement = ng.init('<div jqm-page><div jqm-header ' + ngAttrs + '>' + content + '</div></div>');
            jqmElement = jqm.init('<div data-role="page"><div data-role="header" ' + jqmAttrs + '>' + content + '</div><div data-role="content"></div>');
        }
